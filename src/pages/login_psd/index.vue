<template>
  <div class="container">
    ...
    <footer>
      登陆即代表您已同意<span class="main_color" @click="openFile('https://file.meixinglobal.com/media/20180914/ee7a9a6f-ebfb-496d-9f6b-12fac896c86f.pdf')">iTrade使用条款</span>与<span class="main_color" @click="openFile('https://doc.meixinglobal.com/docs/20170725/80af03af-6870-44ad-aa60-06b1b05892be.pdf')">信息保密协议</span>
    </footer>
  </div>
</template>
